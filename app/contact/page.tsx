...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with FamilyDoctorDirectories.com. Send a message or email hello@directoriesnetwork.com for questions about our directory or featured listings.",
  alternates: {
    canonical: "/contact",
    languages: {
